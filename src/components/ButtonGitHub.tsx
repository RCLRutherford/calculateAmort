...
const ButtonCalculate = ({url}: ButtonProps) => {
    return (
        <a
            href={url}
            target="_blank"
            rel="noreferrer"
            className="px-4 py-3 flex uppercase items-center justify-center text-slate-200 bg-slate-900/90 hover:text-slate-50 hover:bg-[#3B7EC9] rounded-md shadow-lg">
            <svg className="w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                <path
