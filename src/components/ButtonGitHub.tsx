...
const ButtonCalculate = ({url, text}: ButtonProps) => {
    return (
        <a
            href={url}
            target="_blank"
            rel="noreferrer"
            className="px-4 py-3 flex uppercase items-center justify-center text-slate-200 bg-gray-900 hover:text-slate-50 hover:bg-black rounded-md shadow-lg">
