...
const ButtonCalculate = ({url}: ButtonProps) => {
    return (
        <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-3 flex uppercase items-center justify-center text-slate-200 bg-slate-900/60 hover:text-slate-50 hover:bg-[#3B7EC9] rounded-md shadow-lg">
